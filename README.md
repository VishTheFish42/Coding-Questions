...
Below is a list of the problem descriptions tackled thus far, split by topic. This layout follows the Cracking the Coding Interview, 6th Edition chapter layout for easier finding of problems and includes problems from there as well. If it is an explicit problem, the problem number will be noted.
...
4.  ADJACENT ELEMENTS: Given a two-dimensional array and the position of an element (rows and columns start with 1), return the values of all ADJACENT elements (neighbors that are not diagonal).
...
1.  MAXIMUM SUBARRAY: Given an array of integers, return the starting index and ending index of the subarray that has the largest sum.
